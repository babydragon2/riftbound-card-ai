...
# download OGS proving grounds too
for i in range(0, 30):
    code = f"{i:03}"
    url = f"https://cdn.rgpub.io/public/live/map/riftbound/latest/OGS/cards/OGS-{code}/full-desktop.jpg"
    ...
    try:
        ...
        # Generate a filename (e.g., card_1.jpg)
        img_name = f"OGS_{code}.{url.split('.')[-1]}"
        img_path = os.path.join(save_dir, img_name)
